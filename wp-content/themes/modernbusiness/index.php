<!-- blog page is done in index file -->
<?php get_header(); ?>
<section class="py-5">
<div class="container px-5">
    ...
    <?php
    $args = array(
        'posts_per_page'     => 1, // Correct parameter name
        'post__in'           => get_option('sticky_posts'),
        'ignore_sticky_posts' => 1, // Ensure sticky posts are included
    );
        ...
        <div class="card-body p-0">
            <div class="row gx-0">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="bg-featured-blog" style="background-image: url('<?php echo esc_url(get_the_post_thumbnail_url(get_the_ID(), 'mb-blog-hero')); ?>')"></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <?php
            ...
            <div class="card h-100 shadow border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <a class="text-decoration-none link-dark stretched-link" href="<?php the_permalink(); ?>"></div>
                        <div class="h5 card-title mb-3"><?php the_title(); ?></div></a>
