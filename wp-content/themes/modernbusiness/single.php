	...
	<div class="container px-5 my-5">
		<div class="row gx-5">
			<div class="col-lg-3">
				...
				<img class="img-fluid rounded-circle" src="<?php echo esc_url(get_avatar_url(get_the_author_meta('ID'), array('size' => 50))); ?>" alt="..." />
					<div class="ms-3">
			...
			<div class="col-lg-9">
				...
				<article>
					...
					<header class="mb-4">
						...
						<?php
						foreach ($categories as $category) {
							echo '<a class="badge bg-secondary text-decoration-none link-light me-1" href="'./*get_the_category_list($category->cat_ID).*/'">'.$category->name.'</a>';
						}
						?>
					</header>
